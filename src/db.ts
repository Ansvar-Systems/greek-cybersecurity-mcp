/**
 * SQLite database access layer for the Greek Cybersecurity (NCSA) MCP server.
 *
 * Schema:
 *   - guidance    — NCSA guidelines, technical reports, and standards (TR, IT-Grundschutz, BSI-Standard)
